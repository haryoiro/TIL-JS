...
__webpack_require__(/*! ./gameMain.js */ "./gameMain.js");
...
};var socketParameter = 'displayName=' + gameObj.myDisplayName + '&thumbUrl=' + gameObj.myThumbUrl;
var socket = (0, _socket2.default)(mainDoc.getAttribute('data-ipAddress') + '?' + socketParameter);
